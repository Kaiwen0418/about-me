...
const ArtDisplay = ({ showText, artData }) => (
  <>
    <img src={artData.images.front} alt="Hopper Overlay" className="absolute left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2 w-auto h-auto max-w-full max-h-full z-30" />
